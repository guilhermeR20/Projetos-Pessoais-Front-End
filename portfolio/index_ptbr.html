    ...
    <footer class="footer" id="contato">
        <div class="footer-container">
            ...
            <ul class="footer-contato">
                ...
                <li class="github">
                    <a href="https://github.com/guilhermeR20" target="_blank"><img class="icones"
                            src="./img/icons8-github-50.png" />https://github.com/guilhermeR20</a>
                </li>
                <li class="linkedin">
                    <a href="https://www.linkedin.com/in/guilherme-rocha-b59390196/" target="_blank"><img class="icones"
                            src="./img/icons8-linkedin-50.png" />https://www.linkedin.com/in/guilherme-rocha-b59390196/</a>
                </li>
            </ul>
        </div>
    </footer>
