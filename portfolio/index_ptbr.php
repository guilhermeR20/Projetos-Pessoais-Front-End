...
<body class="dark-mode">
    <header class="header">
        <img class="imagem" src="./img/marca.svg" alt="Nome Guilherme Rocha Lima" />
        <nav>
            <ul class="header-menu">
                <li><a href="#experiencia">Experiência</a></li>
                <li><a href="#formacao">Formação</a></li>
                <li class="teste"><a href="#contato">Contato</a></li>
            </ul>
        </nav>
        <select class="ui dropdown selecionar_idioma">
            <option value="pt-br" data-icon="br flag">Português</option>
            <option value="en" data-icon="us flag">Inglês</option>
    ...
    <main class="introducao">
        <img class="introducao-imagem" src="./img/perfil.png" alt="Foto de Perfil" width="350px" height="350px" />
        <div>
            <h1>
    ...
    <section class="experiencia" id="experiencia" aria-label="Experiência">
        ...
        <div>
            ...
            <div class="empresa">
                ...
                <a class="link-acesso" href="https://geraldofreitas.adv.br/" target="_blank"><b>Clique aqui para acessar
                        o site</b></a>
            </div>
            ...
            <div class="empresa">
                ...
                <a class="link-acesso" href="https://infopalmas.pythonanywhere.com/" target="_blank"><b>Clique aqui para
                        acessar o site</b></a>
            </div>
            <div class="empresa">
                ...
                <a class="descricao"><b>Por motivos de segurança eu não posso postar mais informações do
                        projeto.</b></a>
            </div>
        </div>
    </section>
    ...
    <footer class="footer" id="contato">
        <div class="footer-container">
            ...
            <ul class="footer-contato">
                <li class="email">
                    <img class="icones" src="./img/icon-email.png" />guilherme.rochalima17@gmail.com
                </li>
                <li class="telefone">
                ...
                <li class="github">
                    <a href="https://github.com/guilhermeR20" target="_blank"><img class="icones" src="./img/icons8-github-50.png" />https://github.com/guilhermeR20</a>
                </li>
                <li class="linkedin">
                    <a href="https://www.linkedin.com/in/guilherme-rocha-b59390196/" target="_blank"><img class="icones" src="./img/icons8-linkedin-50.png" />https://www.linkedin.com/in/guilherme-rocha-b59390196/</a>
                </li>
            </ul>
        </div>
    </footer>
